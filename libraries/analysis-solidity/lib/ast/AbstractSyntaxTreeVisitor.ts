...
import { ASTNode, ASTNodeTypeString, ArrayTypeName, AssemblyAssignment, AssemblyBlock, AssemblyCall, AssemblyCase, AssemblyExpression, AssemblyFor, AssemblyFunctionDefinition, AssemblyFunctionReturns, AssemblyIf, AssemblyItem, AssemblyLiteral, AssemblyLocalDefinition, AssemblyStackAssignment, AssemblySwitch, BinaryOperation, Block, BooleanLiteral, Break, BreakStatement, Conditional, Continue, ContinueStatement, ContractDefinition, DecimalNumber, DoWhileStatement, ElementaryTypeName, EmitStatement, EnumDefinition, EnumValue, EventDefinition, Expression, ExpressionStatement, ForStatement, FunctionDefinition, FunctionTypeName, HexNumber, Identifier, IfStatement, ImportDirective, IndexAccess, InheritanceSpecifier, InlineAssemblyStatement, LabelDefinition, Mapping, MemberAccess, ModifierDefinition, ModifierInvocation, NumberLiteral, PragmaDirective, PrimaryExpression, ReturnStatement, SimpleStatement, SourceUnit, StateVariableDeclaration, Statement, StringLiteral, StructDefinition, SubAssembly, ThrowStatement, TupleExpression, TypeName, UserDefinedTypeName, UsingForDeclaration, VariableDeclaration, VariableDeclarationStatement, WhileStatement } from "@solidity-parser/parser/dist/src/ast-types";
...
declare type ASTVisitorExit = {
  [K in keyof ASTTypeMap as `${K}:exit`]?: (path: NodePath<ASTTypeMap[K]>) => boolean | void;
};

export interface AbstractSyntaxTreeVisitor extends ASTVisitorEnter, ASTVisitorExit {
  // groups
  ...
  'AssemblyExpression:exit'?: (path: NodePath<AssemblyExpression>) => boolean | void;
  ...
  'PrimaryExpression:exit'?: (path: NodePath<PrimaryExpression>) => boolean | void;
  ...
  InheritanceSpecifier?: (path: NodePath<InheritanceSpecifier>) => void | boolean;
  StateVariableDeclaration?: (path: NodePath<StateVariableDeclaration>) => void | boolean;
  ...
  InlineAssemblyStatement?: (path: NodePath<InlineAssemblyStatement>) => void | boolean;
  ...
  VariableDeclarationStatement?: (path: NodePath<VariableDeclarationStatement>) => void | boolean;
  ...
  AssemblyLocalDefinition?: (path: NodePath<AssemblyLocalDefinition>) => void | boolean;
  AssemblyAssignment?: (path: NodePath<AssemblyAssignment>) => void | boolean;
  AssemblyStackAssignment?: (path: NodePath<AssemblyStackAssignment>) => void | boolean;
  ...
  AssemblyFunctionDefinition?: (path: NodePath<AssemblyFunctionDefinition>) => void | boolean;
  AssemblyFunctionReturns?: (path: NodePath<AssemblyFunctionReturns>) => void | boolean;
  ...
  "ContractDefinition:exit"?: (path: NodePath<ContractDefinition>) => void | boolean;
  "InheritanceSpecifier:exit"?: (path: NodePath<InheritanceSpecifier>) => void | boolean;
  "StateVariableDeclaration:exit"?: (path: NodePath<StateVariableDeclaration>) => void | boolean;
  "UsingForDeclaration:exit"?: (path: NodePath<UsingForDeclaration>) => void | boolean;
  "StructDefinition:exit"?: (path: NodePath<StructDefinition>) => void | boolean;
  "ModifierDefinition:exit"?: (path: NodePath<ModifierDefinition>) => void | boolean;
  "ModifierInvocation:exit"?: (path: NodePath<ModifierInvocation>) => void | boolean;
  "FunctionDefinition:exit"?: (path: NodePath<FunctionDefinition>) => void | boolean;
  ...
  "VariableDeclaration:exit"?: (path: NodePath<VariableDeclaration>) => void | boolean;
  "UserDefinedTypeName:exit"?: (path: NodePath<UserDefinedTypeName>) => void | boolean;
  "Mapping:exit"?: (path: NodePath<Mapping>) => void | boolean;
  "ArrayTypeName:exit"?: (path: NodePath<ArrayTypeName>) => void | boolean;
  "FunctionTypeName:exit"?: (path: NodePath<FunctionTypeName>) => void | boolean;
  "Block:exit"?: (path: NodePath<Block>) => void | boolean;
  "ExpressionStatement:exit"?: (path: NodePath<ExpressionStatement>) => void | boolean;
  ...
  "InlineAssemblyStatement:exit"?: (path: NodePath<InlineAssemblyStatement>) => void | boolean;
  "DoWhileStatement:exit"?: (path: NodePath<DoWhileStatement>) => void | boolean;
  "ContinueStatement:exit"?: (path: NodePath<ContinueStatement>) => void | boolean;
  ...
  >) => void | boolean;
  "ElementaryTypeName:exit"?: (path: NodePath<ElementaryTypeName>) => void | boolean;
  "AssemblyBlock:exit"?: (path: NodePath<AssemblyBlock>) => void | boolean;
  "AssemblyCall:exit"?: (path: NodePath<AssemblyCall>) => void | boolean;
  "AssemblyLocalDefinition:exit"?: (path: NodePath<AssemblyLocalDefinition>) => void | boolean;
  "AssemblyAssignment:exit"?: (path: NodePath<AssemblyAssignment>) => void | boolean;
  "AssemblyStackAssignment:exit"?: (path: NodePath<AssemblyStackAssignment>) => void | boolean;
  ...
  >) => void | boolean;
  "AssemblyFunctionReturns:exit"?: (path: NodePath<AssemblyFunctionReturns>) => void | boolean;
