...
const DataCollector = require("../../instrumentation-solidity/lib/collector"); // Local version
...
class API {
  constructor(config = {}) {
    ...
    this.gasLimit = 0xff_ff_ff_ff_ff; // default "gas sent" with transactions
  ...
  async report(_folder) {
    ...
    return new Promise((resolve, reject) => {
      try {
        ...
        for (const report of this.istanbulReporter) reporter.add(report);
